    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          className="fixed inset-0 bg-[#7978789a] bg-opacity-50 overflow-y-auto h-full w-full flex items-center justify-center z-50"
          onClick={onClose}
        >
          <motion.div
            key="modal"
            ...
            className="relative p-8 w-full h-fit" // Добавляем внешний padding
            onClick={(e) => e.stopPropagation()}
          >
            <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-auto mb-32 p-6 max-h-screen overflow-y-auto">
              {/* содержимое модалки */}
              ...
              <Form {...form}>
                <form onSubmit={onSubmit} className="space-y-4">
                  ...
                  <div className="flex justify-between mt-6 space-x-3">
                    ...
                    >
                      {mode === "edit" ? "Сохранить" : "Добавить"} в любом
                      случае
                    </Button>
